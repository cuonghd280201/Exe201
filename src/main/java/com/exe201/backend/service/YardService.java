...
import com.exe201.backend.api.owner.yard.request.SubYardRequest;
import com.exe201.backend.api.owner.yard.request.YardRequest;
import com.exe201.backend.api.owner.yard.response.GetYardDetailResponse;
import com.exe201.backend.api.owner.yard.response.GetYardInBookingResponse;
import com.exe201.backend.api.owner.yard.response.GetYardResponse;
import com.exe201.backend.api.yard.search.YardResponse;
import com.exe201.backend.entity.*;
import com.exe201.backend.model.*;
import com.exe201.backend.myrepository.YardCustomRepository;
import com.exe201.backend.irepository.*;
import com.exe201.backend.utils.DateHelper;
import com.exe201.backend.utils.TimeMappingHelper;
...
public class YardService {
    ...
    public void addSubYard(List<SubYardRequest> subYards, String yardId) {
        if (subYards != null && subYards.size() > 0) {
            ...
            List<TypeYardEntity> typeList = typeYardRepository.findAll();
